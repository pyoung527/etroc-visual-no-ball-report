...
## Corpus Check
- 23 files · ~31,177,954 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 322 nodes · 569 edges · 19 communities detected
...
3. `EtrocOpticalPoolTests` - 14 edges
4. `AnalyticsDashboardTests` - 14 edges
5. `LxplusDashboardDeployTests` - 13 edges
...
Cohesion: 0.1
Nodes (11): bind_hybrid(), init_db(), validate_additional_test_schema(), AdditionalTestManifestTests, _canonical_pairs(), create_legacy_comments_db(), create_static_site(), HybridRegistryMigrationTests (+3 more)
...
- **Why does `sha256()` connect `Community 1` to `Community 8`, `Community 0`, `Community 4`?**
