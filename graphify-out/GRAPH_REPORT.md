...
## Corpus Check
- 27 files · ~31,198,620 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 504 nodes · 1014 edges · 21 communities detected
...
1. `append()` - 44 edges
2. `LxplusDashboardDeployTests` - 39 edges
3. `init_db()` - 33 edges
...
Cohesion: 0.1
Nodes (12): bind_hybrid(), init_db(), list_hybrids(), validate_additional_test_schema(), AdditionalTestManifestTests, _canonical_pairs(), create_legacy_comments_db(), create_static_site() (+4 more)
...
Cohesion: 0.14
Nodes (21): canonical_cern_principal(), discover_canonical_pairs(), discover_redirect_aliases(), etroc_error(), _etroc_evidence_identity(), etroc_query(), etroc_reviewer_allowlist(), etroc_viewer() (+13 more)
...
Cohesion: 0.17
Nodes (12): CardStateParser, choose_latest(), classify_comment(), current_states(), main(), make_snapshot(), _replace_fragment(), _replace_one() (+4 more)

### Community 11 - "Community 11"
Cohesion: 0.16
Nodes (6): parseVerifiedPublication(), validate(), HTMLParser, _classes(), DashboardStructureParser, TabLocalDashboardTests
...
- **Why does `append()` connect `Community 4` to `Community 0`, `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 14`?**
  _High betweenness centrality (0.378) - this node is a cross-community bridge._
- **Why does `sha256()` connect `Community 6` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 10`, `Community 11`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `init_db()` connect `Community 1` to `Community 3`, `Community 5`?**
