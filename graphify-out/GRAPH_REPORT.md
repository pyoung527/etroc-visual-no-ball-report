...
## Corpus Check
- 27 files · ~31,206,071 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 543 nodes · 1056 edges · 20 communities detected
...
1. `LxplusDashboardDeployTests` - 78 edges
2. `append()` - 46 edges
3. `init_db()` - 33 edges
