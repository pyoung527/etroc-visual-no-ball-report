...
## Corpus Check
- 27 files · ~31,202,432 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 531 nodes · 1042 edges · 19 communities detected
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 147 edges (avg confidence: 0.8)
...
1. `LxplusDashboardDeployTests` - 66 edges
2. `append()` - 44 edges
3. `init_db()` - 33 edges
...
Cohesion: 0.06
Nodes (32): bind_hybrid(), canonical_cern_principal(), discover_canonical_pairs(), discover_redirect_aliases(), etroc_error(), _etroc_evidence_identity(), etroc_query(), etroc_reviewer_allowlist() (+24 more)
...
- **Why does `append()` connect `Community 5` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`?**
  _High betweenness centrality (0.456) - this node is a cross-community bridge._
- **Why does `parse_args()` connect `Community 7` to `Community 9`, `Community 10`, `Community 6`?**
  _High betweenness centrality (0.212) - this node is a cross-community bridge._
- **Why does `LxplusDashboardDeployTests` connect `Community 2` to `Community 7`?**
