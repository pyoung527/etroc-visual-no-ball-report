...
## Corpus Check
- 27 files · ~31,205,271 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 540 nodes · 1053 edges · 21 communities detected
...
1. `LxplusDashboardDeployTests` - 75 edges
2. `append()` - 46 edges
3. `init_db()` - 33 edges
...
Cohesion: 0.08
Nodes (53): applyQueue(), canonicalComparator(), canonicalMontageUri(), canSaveActive(), closeDialog(), controls(), controlsEnabled(), currentDraft() (+45 more)
...
Cohesion: 0.1
Nodes (23): MontageController, exact_owned_replica_sets(), main(), owner_matches(), pod_owned_by_replica_set(), pod_uses_pvc(), select_single_app_pod(), validate_all_pvc_pods() (+15 more)
...
Cohesion: 0.14
Nodes (20): canonical_cern_principal(), discover_canonical_pairs(), discover_redirect_aliases(), etroc_error(), etroc_query(), etroc_reviewer_allowlist(), etroc_viewer(), Handler (+12 more)
...
- **Why does `LxplusDashboardDeployTests` connect `Community 0` to `Community 4`, `Community 5`?**
  _High betweenness centrality (0.219) - this node is a cross-community bridge._
- **Why does `sha256()` connect `Community 6` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 9`, `Community 11`?**
