...
## Corpus Check
- 21 files · ~31,173,158 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 280 nodes · 498 edges · 18 communities detected
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 57 edges (avg confidence: 0.8)
...
3. `AnalyticsDashboardTests` - 14 edges
4. `LxplusDashboardDeployTests` - 13 edges
5. `EtrocOpticalPoolTests` - 13 edges
6. `build_pool()` - 12 edges
7. `load_server_module()` - 10 edges
8. `sha256()` - 9 edges
9. `Handler` - 9 edges
10. `main()` - 8 edges
...
Cohesion: 0.09
Nodes (13): bind_hybrid(), discover_canonical_pairs(), discover_redirect_aliases(), init_db(), validate_additional_test_schema(), AdditionalTestManifestTests, _canonical_pairs(), create_legacy_comments_db() (+5 more)
...
Cohesion: 0.21
Nodes (14): Handler, identity(), json_response(), list_hybrids(), load_additional_tests_manifest(), mutation_request_error(), normalize_status(), normalize_target() (+6 more)
...
Cohesion: 0.18
Nodes (13): exact_owned_replica_sets(), main(), owner_matches(), pod_owned_by_replica_set(), pod_uses_pvc(), select_single_app_pod(), validate_all_pvc_pods(), HybridRegistryDeploymentTests (+5 more)

### Community 6 - "Community 6"
Cohesion: 0.19
Nodes (10): animateCounters(), csvCell(), loadAdditionalTests(), loadReviewStatus(), renderDonut(), safeSpreadsheetValue(), setKpi(), setState() (+2 more)
...
Cohesion: 0.42
Nodes (9): compact(), fail(), load_object(), main(), parse_args(), Normalize API-defaulted empty containers without hiding non-empty drift., require_int(), require_mapping() (+1 more)
...
Cohesion: 0.48
Nodes (5): element(), render(), renderCard(), renderSummary(), safeAssetUri()
...
- **Why does `sha256()` connect `Community 1` to `Community 0`, `Community 2`?**
  _High betweenness centrality (0.156) - this node is a cross-community bridge._
- **Why does `make_snapshot()` connect `Community 2` to `Community 1`, `Community 4`?**
