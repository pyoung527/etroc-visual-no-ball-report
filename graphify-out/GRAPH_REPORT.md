...
## Corpus Check
- 29 files · ~34,262,873 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 640 nodes · 1353 edges · 20 communities detected
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 229 edges (avg confidence: 0.8)
...
Cohesion: 0.08
Nodes (29): append_etroc_review(), canonical_cern_principal(), etroc_error(), _etroc_evidence_identity(), etroc_query(), etroc_reviewer_allowlist(), etroc_viewer(), Handler (+21 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (17): bind_hybrid(), discover_canonical_pairs(), discover_redirect_aliases(), init_db(), list_hybrids(), load_additional_tests_manifest(), source_identifier_pair(), split_pair_key() (+9 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (31): append(), _asset_bytes(), audit(), _checksum_inventory(), _completion(), completion_summary(), _current(), _digest() (+23 more)

### Community 5 - "Community 5"
Cohesion: 0.11
Nodes (19): atomic_replace_directory(), build_pool(), height_publication(), int_field(), load_height_contract(), main(), position_publication(), render_clean_montage() (+11 more)

### Community 6 - "Community 6"
Cohesion: 0.12
Nodes (30): analyze_one(), grid_centers(), grid_scores(), main(), optical_labels(), overlay(), _peaks(), read_manifest() (+22 more)
...
Cohesion: 0.15
Nodes (7): parseVerifiedPublication(), validate(), parsePublication(), utcTimestamp(), _classes(), DashboardStructureParser, TabLocalDashboardTests
...
- **Why does `append()` connect `Community 4` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 14`?**
  _High betweenness centrality (0.312) - this node is a cross-community bridge._
- **Why does `append()` connect `Community 6` to `Community 2`, `Community 3`, `Community 5`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 14`?**
  _High betweenness centrality (0.228) - this node is a cross-community bridge._
- **Why does `LxplusDashboardDeployTests` connect `Community 1` to `Community 6`, `Community 7`?**
  _High betweenness centrality (0.208) - this node is a cross-community bridge._
- **Are the 46 inferred relationships involving `append()` (e.g. with `.handle_data()` and `.handle_endtag()`) actually correct?**
  _`append()` has 46 INFERRED edges - model-reasoned connections that need verification._
