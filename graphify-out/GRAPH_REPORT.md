# Graph Report - bbqc-etroc-oi-2608  (2026-08-20)

## Corpus Check
- 27 files · ~31,206,650 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 545 nodes · 1058 edges · 20 communities detected
...
1. `LxplusDashboardDeployTests` - 80 edges
2. `append()` - 46 edges
3. `init_db()` - 33 edges
...
Cohesion: 0.08
Nodes (13): bind_hybrid(), discover_canonical_pairs(), discover_redirect_aliases(), init_db(), validate_additional_test_schema(), AdditionalTestManifestTests, create_legacy_comments_db(), create_static_site() (+5 more)

### Community 3 - "Community 3"
Cohesion: 0.12
Nodes (12): append_etroc_review(), _etroc_evidence_identity(), init_etroc_review_schema(), initialize_store(), load_etroc_review_evidence(), reset_etroc_review_evidence_cache(), EvidenceTests, load_server_module() (+4 more)
...
Cohesion: 0.12
Nodes (16): atomic_replace_directory(), build_pool(), int_field(), main(), render_jpegs(), resolve_under(), sha256(), validate_position_results() (+8 more)
...
Cohesion: 0.17
Nodes (19): canonical_cern_principal(), etroc_error(), etroc_query(), etroc_reviewer_allowlist(), etroc_viewer(), Handler, identity(), json_response() (+11 more)
...
- **Why does `append()` connect `Community 4` to `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 14`?**
  _High betweenness centrality (0.535) - this node is a cross-community bridge._
- **Why does `LxplusDashboardDeployTests` connect `Community 0` to `Community 4`, `Community 6`?**
  _High betweenness centrality (0.232) - this node is a cross-community bridge._
- **Why does `sha256()` connect `Community 5` to `Community 1`, `Community 3`, `Community 4`, `Community 10`, `Community 11`?**
