...
## Corpus Check
- 29 files · ~34,259,564 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 619 nodes · 1305 edges · 21 communities detected
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 220 edges (avg confidence: 0.8)
...
3. `append()` - 47 edges
4. `init_db()` - 33 edges
5. `updateDialog()` - 21 edges
6. `HybridRegistryMigrationTests` - 21 edges
7. `saveReview()` - 20 edges
8. `load_etroc_review_evidence()` - 19 edges
9. `ETROCReviewFrontendTests` - 17 edges
...
Cohesion: 0.06
Nodes (71): applyQueue(), canonicalComparator(), canonicalMontageUri(), canSaveActive(), closeDialog(), controls(), controlsEnabled(), currentDraft() (+63 more)
...
Cohesion: 0.09
Nodes (12): bind_hybrid(), init_db(), list_hybrids(), validate_additional_test_schema(), AdditionalTestManifestTests, create_legacy_comments_db(), create_static_site(), HybridRegistryHttpTests (+4 more)

### Community 3 - "Community 3"
Cohesion: 0.11
Nodes (26): append(), _asset_bytes(), audit(), _checksum_inventory(), _current(), _digest(), _drop_empty_legacy_schema(), _event() (+18 more)

### Community 4 - "Community 4"
Cohesion: 0.12
Nodes (17): atomic_replace_directory(), build_pool(), int_field(), main(), position_publication(), render_clean_montage(), render_jpegs(), resolve_under() (+9 more)

### Community 5 - "Community 5"
Cohesion: 0.12
Nodes (24): canonical_cern_principal(), discover_canonical_pairs(), discover_redirect_aliases(), etroc_error(), _etroc_evidence_identity(), etroc_query(), etroc_reviewer_allowlist(), etroc_viewer() (+16 more)
...
Cohesion: 0.14
Nodes (8): parseVerifiedPublication(), validate(), parsePublication(), updateCardReview(), utcTimestamp(), _classes(), DashboardStructureParser, TabLocalDashboardTests
...
- **Why does `append()` connect `Community 3` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 15`?**
  _High betweenness centrality (0.307) - this node is a cross-community bridge._
- **Why does `append()` connect `Community 6` to `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 15`?**
  _High betweenness centrality (0.237) - this node is a cross-community bridge._
- **Why does `LxplusDashboardDeployTests` connect `Community 1` to `Community 8`, `Community 6`?**
  _High betweenness centrality (0.214) - this node is a cross-community bridge._
- **Are the 44 inferred relationships involving `append()` (e.g. with `.handle_data()` and `.handle_endtag()`) actually correct?**
